...
**Que:-7 What is the difference between the ‘id’ attribute and the ‘class’ attribute of HTML
elements? :(**
...
**Ans:** :)
  ...
  **differences between Cell padding and cell spacing**
...
**Que:-10 How can we club two or more rows or columns into a single row or column in an HTML
table?**:(
...
**Ans:**:)
  ...
  <h4> Difference between HTML and XHTML</h4>
